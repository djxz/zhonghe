      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="地点" prop="place">
            <el-select v-model="formInfo.place" :placeholder="isEdit ? '' : '请选择地点'" style="width: 100%" :disabled="isEdit"
              clearable>
              <el-option v-for="dict in dict.type.dm_investigation_place" :disabled="dict.value === '3'"
        ...
        <el-col :span="12">
          <el-form-item label="调查时间" prop="time">
            <el-date-picker v-model="formInfo.time" type="datetime" value-format="yyyy-MM-dd HH:mm:ss"
              :placeholder="isEdit ? '' : '请选择调查时间'" :disabled="isEdit" style="width: 100%" clearable :picker-options="{
                disabledDate(time) {
                  // 禁用所有小于当前日期的日期
        ...
        <el-col :span="24">
          <el-form-item label="参加人" prop="participant">
            <el-input v-model="formInfo.participant" :placeholder="isEdit ? '' : '请输入参加人'" :disabled="isEdit" maxlength="50"
              show-word-limit clearable />
          </el-form-item>
        </el-col>
        <el-col :span="24">
          <el-form-item label="被调查人" prop="respondent">
            <el-input :placeholder="isEdit ? '' : '请输入被调查人'" v-model="formInfo.respondent" :disabled="isEdit"
              maxlength="100" show-word-limit clearable />
          </el-form-item>
        </el-col>
        <el-col :span="24">
          <el-form-item label="提交证据或资料名称" prop="recorder">
            <el-input type="textarea" v-model="formInfo.recorder" :placeholder="isEdit ? '' : '请输入提交证据或资料名称'"
              :disabled="isEdit" maxlength="100" show-word-limit clearable />
          </el-form-item>
        </el-col>
        <el-col :span="24">
          <el-form-item label="记录" prop="record">
            <el-input type="textarea" v-model="formInfo.record" :placeholder="isEdit ? '' : '请输入记录'" :disabled="isEdit"
              maxlength="500" show-word-limit :autosize="{ minRows: 3 }" clearable />
          </el-form-item>
        </el-col>
      </el-row>
    </el-form>
