...
<template xmlns="http://www.w3.org/1999/html">
    <el-dialog :title="title" :visible.sync="visible" width="1200px" append-to-body :close-on-click-modal="false" :close-on-press-escape="false">
        <el-form ref="form" :model="form" :rules="rules" label-width="120px">
                ...
                <el-row>
                    <el-col :span="12" v-if="form.feedbackTime">
                        <el-form-item label="反馈时间" prop="feedbackTime">
                            <el-date-picker clearable v-model="form.feedbackTime" type="date" value-format="yyyy-MM-dd-HH-mm-ss" style="width: 100%" disabled></el-date-picker>
                        </el-form-item>
                    </el-col>
                </el-row>
            </div>
            ...
            <!-- <el-row>
                <el-col :span="12">
                    <el-form-item label="自收案件机构类型" prop="institutionType" label-width="125px">
            ...
            <el-row v-if="DEPT_TYPE.bankList.includes(form.deptType) || DEPT_TYPE.nonBankList.includes(form.deptType)">
                <el-col :span="12">
                    <el-form-item label="业务经办人员" prop="deptHandlerName" :rules="[{ required: SYS_YES_NO.sys_no !== form.deptAcceptMediate, message: '业务经办人员为必填项', trigger: 'blur' }]">
                        <el-input v-model="form.deptHandlerName" maxlength="10" clearable :placeholder="disabled ? '' : '请输入业务经办人员'" :disabled="disabled" />
                    </el-form-item>
                </el-col>
                <el-col :span="12">
                    <el-form-item
                    ...
                    >
                        <el-input v-model="form.deptHandlerPhone" maxlength="11" clearable :placeholder="disabled ? '' : '请输入经办人员联系电话'" :disabled="disabled" />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row v-if="DEPT_TYPE.bankList.includes(form.deptType) || DEPT_TYPE.nonBankList.includes(form.deptType)">
                <el-col :span="12">
                    ...
                    >
                        <el-input v-model="form.deptHandlerCertNum" maxlength="18" clearable :placeholder="disabled ? '' : '请输入经办人身份证号'" :disabled="disabled" />
                    </el-form-item>
                </el-col>
                <el-col :span="12">
                    <el-form-item label="投诉分类" prop="bankComplaintType" :rules="[{ required: SYS_YES_NO.sys_no !== form.deptAcceptMediate, message: '投诉分类为必填项', trigger: 'change' }]">
                        <el-select v-model="form.bankComplaintType" style="width: 100%" clearable :placeholder="disabled ? '' : '请选择投诉分类'" :disabled="disabled">
            ...
            <el-row v-if="DEPT_TYPE.bankList.includes(form.deptType) || DEPT_TYPE.nonBankList.includes(form.deptType)">
                <el-col :span="12">
                    <el-form-item label="业务办理渠道" prop="handleChannel" :rules="[{ required: SYS_YES_NO.sys_no !== form.deptAcceptMediate, message: '业务办理渠道为必填项', trigger: 'change' }]">
                        <el-select v-model="form.handleChannel" style="width: 100%" clearable :placeholder="disabled ? '' : '请选择业务办理渠道'" :disabled="disabled">
            ...
            <el-row v-if="DEPT_TYPE.insuranceList.includes(form.deptType)">
                <el-col :span="12">
                    <el-form-item label="险种类别" prop="insuranceType1" :rules="[{ required: SYS_YES_NO.sys_no !== form.deptAcceptMediate, message: '险种类别为必填项', trigger: 'change' }]">
                        <el-cascader
                ...
                <el-col :span="12">
                    <el-form-item label="险种类别2" prop="insuranceType2">
                        <el-input v-model="form.insuranceType2" placeholder="请输入险种类别2" clearable maxlength="40" show-word-limit :disabled="disabled" />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row v-if="DEPT_TYPE.insuranceList.includes(form.deptType)">
            ...
            <el-row>
                <el-col :span="24">
                    <el-form-item label="投诉内容" prop="complaintContent">
                        <el-input v-model="form.complaintContent" type="textarea" maxlength="5000" disabled :autosize="{ minRows: 3 }" />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
            ...
            <el-row>
                <el-col :span="12">
                    <el-form-item label="金融机构是否接受调解" prop="deptAcceptMediate" label-width="165px">
                        <el-select v-model="form.deptAcceptMediate" :placeholder="disabled ? '' : '请选择金融机构是否接受调解'" clearable style="width: 100%" :disabled="disabled">
                            <el-option v-for="dict in dict.type.sys_yes_no" :key="dict.value" :label="dict.label" :value="dict.value"></el-option>
                        </el-select>
                    </el-form-item>
                </el-col>
                <el-col :span="12" v-if="form.createType === DM_CREATE_TYPE.TYPE2">
                    ...
                    >
                        <el-select v-model="form.consumerAcceptMediate" :placeholder="disabled ? '' : '请选择金融消费者是否接受调解'" clearable style="width: 100%" :disabled="disabled">
                            <el-option v-for="dict in dict.type.sys_yes_no" :key="dict.value" :label="dict.label" :value="dict.value"></el-option>
                        </el-select>
                    </el-form-item>
                </el-col>
            ...
            <el-row v-if="DEPT_TYPE.insuranceList.includes(form.deptType)">
                <el-col :span="12">
                    <el-form-item label="投保人" prop="policyholder">
                        <el-input v-model="form.policyholder" :placeholder="disabled ? '' : '请输入投保人'" clearable maxlength="10" show-word-limit :disabled="disabled"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="12">
                    <el-form-item label="被保险人" prop="insured">
                        <el-input v-model="form.insured" :placeholder="disabled ? '' : '请输入被保险人'" clearable maxlength="10" show-word-limit :disabled="disabled"></el-input>
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row v-if="DEPT_TYPE.insuranceList.includes(form.deptType)">
            ...
            <el-row v-if="DEPT_TYPE.insuranceList.includes(form.deptType)">
                <el-col :span="12">
                    <el-form-item label="销售人员（网点、理赔人员）" prop="salesman">
                        <el-input v-model="form.salesman" :placeholder="disabled ? '' : '请输入销售人员（网点、理赔人员）'" clearable maxlength="10" show-word-limit :disabled="disabled" />
                    </el-form-item>
                </el-col>
                <el-col :span="12">
                    <el-form-item label="销售、网点、理赔工号" prop="salesmanJobNum">
                        <el-input v-model="form.salesmanJobNum" :placeholder="disabled ? '' : '请输入销售、网点、理赔工号'" clearable maxlength="10" show-word-limit :disabled="disabled" />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row v-if="DEPT_TYPE.insuranceList.includes(form.deptType)">
            ...
            <el-row>
                <el-col :span="12">
                    <el-form-item label="姓名" prop="deptContact" label-width="130px" :rules="[{ required: SYS_YES_NO.sys_no !== form.deptAcceptMediate, message: '姓名为必填项', trigger: 'blur' }]">
                        <el-input v-model="form.deptContact" :placeholder="disabled ? '' : '请输入姓名'" clearable maxlength="10" show-word-limit :disabled="disabled" />
                    </el-form-item>
                </el-col>
                <el-col :span="12">
            ...
            <el-row>
                ...
                <el-col :span="12">
                    ...
                    >
                        <el-input v-model="form.deptContactPosition" :placeholder="disabled ? '' : '请输入所在部门及职务'" clearable maxlength="30" show-word-limit :disabled="disabled" />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
