...
<template>
    <el-dialog
        ...
        :show-close="false"
        custom-class="evidence-comparison-dialog"
        @closed="handleClosed"
    >
        <div class="ec-report">
            <!-- 顶部标题栏 -->
            ...
            <div class="ec-body" v-loading="loading">
                        ...
                        <div class="ec-result-hero__main">
                            <div class="ec-advantage-block">
                                ...
                                <div class="ec-advantage-bar">
                                    <div
                                        class="ec-advantage-bar__inst"
                                        :style="{ width: reportData.finalResult.institutionAdvantage + '%' }"
                                    />
                                    <div
                                        class="ec-advantage-bar__cons"
                ...
                <section class="ec-section">
                    ...
                    <div
                        v-for="point in reportData.disputePoints"
                        :key="point.index"
                        class="ec-dispute-card"
                    >
                ...
                <section class="ec-section">
                    ...
                    <div class="ec-dimension-chart">
                        ...
                        <div
                            v-for="dim in reportData.conclusionBasis.dimensions"
                            :key="dim.name"
                            class="ec-dimension-row"
                        >
...
<script>
import { getEvidenceComparisonData } from './evidenceComparisonMock';
...
export default {
    ...
    data() {
        return {
            ...
            confirming: false,
            row: {},
            reportData: getEvidenceComparisonData()
        };
    },
    methods: {
        open(row) {
        ...
        loadReport() {
            ...
            // 模拟接口请求，后续可替换为真实 API
            setTimeout(() => {
                this.reportData = getEvidenceComparisonData(this.row.workOrderId);
                this.loading = false;
            }, 400);
        },
        handleRegenerate() {
