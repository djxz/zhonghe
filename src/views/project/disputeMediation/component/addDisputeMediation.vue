          ...
          <el-row v-if="$store.getters.userInfo.isDMInstitution">
            <el-col :span="24">
              <el-form-item label="人民调解申请书" prop="applicationAttachment"
                :rules="[{ required: this.$store.getters.userInfo.isDMInstitution && SYS_YES_NO.sys_yes === this.form.consumerAcceptMediate, message: '请上传《人民调解申请书》或其他金融消费者同意调解作证材', trigger: 'change' }]">
