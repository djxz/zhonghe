      ...
      <el-form ref="form" :model="form" label-width="120px">
        ...
        <div>
          ...
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item :label="form.oldDeptId && !$store.getters.userInfo.isDMInstitution ? '实际机构类型' : '机构类型'"
                prop="type">
        ...
        <el-row v-if="!$store.getters.userInfo.isDMInstitution">
          <el-col :span="12">
            <el-form-item label="案件类型" prop="selfCollectionCaseType">
              <el-select v-if="DEPT_TYPE.insuranceList.includes(form.deptType)" v-model="form.selfCollectionCaseType"
                :placeholder="disabled ? '' : '请选择案件类型'" clearable style="width: 100%" disabled>
          ...
          <el-col :span="12">
            <el-form-item label="是否适用小额快处机制" prop="smallCaseFlag" label-width="170px">
              <el-select v-model="form.smallCaseFlag" placeholder="" clearable style="width: 100%" disabled>
                <el-option v-for="dict in dict.type.sys_yes_no" :key="dict.value" :label="dict.label"
                  :value="dict.value"></el-option>
              </el-select>
            </el-form-item>
        ...
        <el-row>
          <el-col v-if="DEPT_TYPE.bankList.includes(form.deptType) || DEPT_TYPE.nonBankList.includes(form.deptType)"
            ...
            <el-form-item label="协议减免金额（元）" prop="agreedReductionAmount" label-width="140px">
              <el-input v-model="form.agreedReductionAmount" placeholder="" maxlength="12" show-word-limit clearable
                readonly />
            </el-form-item>
          </el-col>
        </el-row>
